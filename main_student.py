...
parser.add_argument('--beta', type=float, default=0.1, help='the scale of cl')
parser.add_argument('--gamma', type=float, default=0.2, help='the scale of kd')
parser.add_argument('--eta', type=float, default=0.2)
parser.add_argument('--hidden_dim',      type=int,   default=256,      help='number of dimensions of input size')
parser.add_argument('--code_book_len',   type=int,   default=3,       help='number of codebooks')
parser.add_argument('--cluster_num',     type=int,   default=256,       help='length of a codebook')
...
def main():
    ...
    emb_model.load_state_dict(torch.load('../code_model_rr_3m_256k_test03.pkl'))
